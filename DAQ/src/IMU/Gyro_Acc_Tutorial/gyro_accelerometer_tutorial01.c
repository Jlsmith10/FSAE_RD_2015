/*
	...
	on a BerryIMU BerryIMU connected to a Raspberry Pi.
	http://ozzmaker.com/
...
int main(int argc, char *argv[])
{
	...
	int  accRaw[3];             // {accX, accY, accZ}
	int  magRaw[3];             // {magX, magY, magZ}
	int  gyrRaw[3];             // {gyroX, gyroY, gyroZ}
